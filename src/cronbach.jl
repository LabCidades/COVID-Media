...
covmatrix_fear = cov(Matrix(select(df, label_fear)))
alpha_fear = cronbachalpha(covmatrix_fear).alpha

# self-efficacy
# hb_b_se, hb_b_pse, hb_b_pbe, hb_a_pba (negative coded, DROPPED!), hb_a_se
label_selfeff = [:hb_b_se, :hb_b_pse, :hb_b_pbe, :hb_a_se]
